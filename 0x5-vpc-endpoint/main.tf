...
module "ec2_aps1_2" {
  source = "./ec2-instance"
  instance_name = "0x1-ec2-aps1-2"
  instance_type = "t2.nano"
  ami_id = "ami-02b8269d5e85954ef"
  key_name = "vpc-test-ap-south-1-ec2-ssh-keys"
  security_group_name = "0x1-sg-aps1"
  vpc_id = module.vpc_layer_aps1.vpc_id
  subnet_id = module.vpc_layer_aps1.subnet_ids.private_id
}

resource "aws_vpc_endpoint" "vpc_endpoint" {
  tags = {
    Name = "0x1-vpc-endpoint-aps1"
  }
  vpc_id = module.vpc_layer_aps1.vpc_id
  service_name = "com.amazonaws.ap-south-1.s3"
  route_table_ids = [module.vpc_layer_aps1.route_table_ids.public_id, module.vpc_layer_aps1.route_table_ids.private_id]
}